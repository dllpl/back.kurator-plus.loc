...
class SendVacationPlan extends UpdateMutation
{
    ...
    {
        if ($this->getModel()->status !== VacationPlan::SAVED) {
            throw new GraphqlException('Report is currently locked for sending');
        }

        $data->status = VacationPlan::SENT;

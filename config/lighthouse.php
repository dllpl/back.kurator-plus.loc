...
return [
    ...
    */
    ...
    'cache' => [
        'enable' => env('LIGHTHOUSE_CACHE_ENABLE', false /* env('APP_ENV') !== 'local' */),
    ...
    */
    ...
    'namespaces' => [
        ...
        'mutations' => [
            ...
            'App\\GraphQL\\Mutations\\Core',
            'App\\GraphQL\\Mutations\\Report',
        ],
...
//    'paginate_max_count' => 100,
    ...
    /*
     | Use this “count” value if "first" query argument
     | or "defaultCount" schema parameter are omitted.
     */
